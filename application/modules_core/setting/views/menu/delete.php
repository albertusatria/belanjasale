    ...
    <div class="contentpanel">
      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          ...
          <h4 class="panel-title">Delete Menu <?= $result['menu_name']; ?></h4>
          <p>Delete menu</p>
        </div>
        <form id="sasPanel" class="form-horizontal form-bordered" method="POST" action="<?php echo base_url(); ?>setting/menu/delete_process">
        ...
        <div class="panel-body panel-body-nopadding">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <select class="form-control input-sm mb15" name="parent_id" disabled>
                    <option value=""></option>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-7">
                <input name="menu_name" class="form-control" maxlength="100" type="text" value="<?php echo $result['menu_name']; ?>" disabled />
           ...
           <div class="form-group">
              ...
              <div class="col-sm-7">
                <textarea name="menu_desc" class="form-control" rows="5" disabled><?php echo $result['menu_desc']; ?></textarea>
                <!-- <span class="help-block">A block of help text that breaks onto a new line and may extend beyond one line.</span> -->
              </div>
            </div>
           ...
           <div class="form-group">
              ...
              <div class="col-sm-7">
                <input name="menu_url" class="form-control" maxlength="100" type="text" value="<?php echo $result['menu_url']; ?>" disabled />
                <!-- <span class="help-block">A block of help text that breaks onto a new line and may extend beyond one line.</span> -->
              </div>
            </div>
           ...
           <div class="form-group">
              ...
              <div class="col-sm-7">
                <input name="menu_order" class="form-control" maxlength="11" type="text" value="<?php echo $result['menu_order']; ?>" disabled />
                <!-- <span class="help-block">A block of help text that breaks onto a new line and may extend beyond one line.</span> -->
              </div>
            </div>
           ...
           <div class="form-group">
              ...
              <div class="col-sm-7">
                <input name="menu_icon" class="form-control" maxlength="25" type="text" value="<?php echo $result['menu_icon']; ?>" disabled />
                <!-- <span class="help-block">A block of help text that breaks onto a new line and may extend beyond one line.</span> -->
              </div>
            </div>
