    ...
    <form id="sasPanel" class="form-horizontal form-bordered" method="POST" action="<?php echo base_url(); ?>setting/user/edit_profile_process" enctype="multipart/form-data">
    ...
    <div class="contentpanel">
      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          ...
          <p>Edit user profile information area</p>
        </div>
        ...
        <div class="panel-body panel-body-nopadding">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-7">
                <input name="user_full_name" class="form-control" maxlength="100" type="text" value="<?php echo $result['user_full_name']; ?>" required />
           ...
           <div class="form-group">
              ...
              <div class="col-sm-7">
                <input name="user_address" class="form-control" maxlength="255" type="text" value="<?php echo $result['user_address']; ?>" />
                <!-- <span class="help-block">A block of help text that breaks onto a new line and may extend beyond one line.</span> -->
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-7">
                <input name="user_birthday" class="form-control" maxlength="100" type="text" value="<?php echo $result['user_birthday']; ?>" />
                <!-- <span class="help-block">A block of help text that breaks onto a new line and may extend beyond one line.</span> -->
              </div>
            </div>
           ...
           <div class="form-group">
              ...
              <div class="col-sm-7">
                <input name="user_contact" class="form-control" maxlength="12" type="text" value="<?php echo $result['user_number']; ?>" />
                <!-- <span class="help-block">A block of help text that breaks onto a new line and may extend beyond one line.</span> -->
              </div>
            </div>
