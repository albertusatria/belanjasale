    ...
    <div class="contentpanel">
      ...
      <div class="panel panel-default">
        ...
        <form id="sasPanel" class="form-horizontal form-bordered" method="POST" action="<?php echo base_url(); ?>setting/role/edit_process">
        <div class="panel-body panel-body-nopadding">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-7">
                <input name="role_name" class="form-control" maxlength="100" type="text" value="<?php echo $result['role_name']; ?>" required />
           ...
           <div class="form-group">
              ...
              <div class="col-sm-7">
                <textarea name="role_desc" class="form-control" rows="5"><?php echo $result['role_desc']; ?></textarea>
                <!-- <span class="help-block">A block of help text that breaks onto a new line and may extend beyond one line.</span> -->
              </div>
            </div>
           ...
           <div class="form-group">
              ...
              <div class="col-sm-7">
                <input name="role_default_url" class="form-control" maxlength="100" type="text" value="<?php echo $result['role_default_url']; ?>" required />
                <!-- <span class="help-block">A block of help text that breaks onto a new line and may extend beyond one line.</span> -->
              </div>
            </div>
