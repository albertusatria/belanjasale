    ...
    <div class="contentpanel">
      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          ...
          <h4 class="panel-title">Setup Edit Portal</h4>
          <p>Edit portal area</p>
        </div>
        <div class="panel-body panel-body-nopadding">

        <form id="sasPanel" class="form-horizontal form-bordered" method="POST" action="<?php echo base_url(); ?>setting/portal/edit_process">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-7">
                <input name="portal_name" class="form-control" maxlength="100" type="text" value="<?php echo $result['portal_name']; ?>" required />
           ...
           <div class="form-group">
              ...
              <div class="col-sm-7">
                <input name="portal_title" class="form-control" maxlength="100" type="text" value="<?php echo $result['portal_title']; ?>" required />
                <!-- <span class="help-block">A block of help text that breaks onto a new line and may extend beyond one line.</span> -->
              </div>
            </div>
           ...
           <div class="form-group">
              ...
              <div class="col-sm-7">
                <textarea name="portal_desc" class="form-control" rows="5" required><?php echo $result['portal_desc']; ?></textarea>
                <!-- <span class="help-block">A block of help text that breaks onto a new line and may extend beyond one line.</span> -->
              </div>
            </div>
